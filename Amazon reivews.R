...
bose.watch.reviews <- get_reviews("B09V12K8NT")


save(bose.watch.reviews, file = "data/bose.watch.reviews.RData")



load("data/bose.watch.reviews.Rdata")


bose.watch.reviews <- filter(bose.watch.reviews, Verified_Purchase==TRUE)
...
bose.watch.reviews.text <- bose.watch.reviews %>%
  select(reviewText)


stri_enc_mark(bose.watch.reviews.text$reviewText)
bose.watch.reviews.text$reviewText <- sapply(bose.watch.reviews.text$reviewText,
...
bose.watch.reviews.text$reviewText <- tolower(bose.watch.reviews.text$reviewText)

bose.watch.reviews.text$reviewText <- gsub("wasn[\u2019']t", "was not", bose.watch.reviews.text$reviewText)
bose.watch.reviews.text$reviewText <- gsub("won[\u2019']t", "will not", bose.watch.reviews.text$reviewText)
bose.watch.reviews.text$reviewText <- gsub("can[\u2019']t", "can not", bose.watch.reviews.text$reviewText)
bose.watch.reviews.text$reviewText <- gsub("didn[\u2019']t", "did not", bose.watch.reviews.text$reviewText)
bose.watch.reviews.text$reviewText <- gsub("don[\u2019']t", "do not", bose.watch.reviews.text$reviewText)
bose.watch.reviews.text$reviewText <- gsub("I[\u2019']m", "I am", bose.watch.reviews.text$reviewText)
bose.watch.reviews.text$reviewText <- gsub("[\u2019']ve", " have", bose.watch.reviews.text$reviewText) 
bose.watch.reviews.text$reviewText <- gsub("[\u2019|']s", "", bose.watch.reviews.text$reviewText)
bose.watch.reviews.text$reviewText <- gsub("[\u2019']re", " are", bose.watch.reviews.text$reviewText)
bose.watch.reviews.text$reviewText <- gsub("[\u2019']ll", " will", bose.watch.reviews.text$reviewText)


bose.watch.reviews.text$reviewText<- gsub("canceling", "cancelling", bose.watch.reviews.text$reviewText)
bose.watch.reviews.text$reviewText <- gsub("cancellation", "cancelling", bose.watch.reviews.text$reviewText)


bose.watch.reviews.text$reviewText <- removeNumbers(bose.watch.reviews.text$reviewText)

bose.watch.reviews.text$reviewText <- removePunctuation(bose.watch.reviews.text$reviewText)
...
shifted.words <- bose.watch.reviews.text %>%
...
bose.watch.reviews.text <- mgsub(bose.watch.reviews.text$reviewText, negated.phrases, synonyms) %>%
  dplyr::as_data_frame() %>%
...
word.freq.table<- bose.watch.reviews.text %>% 
...
bose.correlation.terms <- bose.watch.reviews.text %>%
...
bigrams.network.df<-bose.watch.reviews.text %>%
  unnest_tokens(bigram, reviewText, token = "ngrams", n = 2) %>%
  separate(bigram, c("word1", "word2"), sep = " ") %>%
  filter(!word1 %in% stop_words$word & !word2 %in% stop_words$word) %>%
